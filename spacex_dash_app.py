...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(dcc.Graph(id='success-pie-chart', style={'width': '50vh'})),
                                html.Br(),
                                ...
                                html.Div(dcc.Graph(id='success-payload-scatter-chart', style={'width': '80vh'})),
                                ])
...
def get_pie_chart(entered_site):
    ...
    print(filtered_df.groupby(['class'])['class'].count())
    if entered_site == 'ALL':
...
def get_scatter_chart(entered_site, payload_range):
    payload_filtered_df = spacex_df[spacex_df["Payload Mass (kg)"].between(payload_range[0], payload_range[1])]
